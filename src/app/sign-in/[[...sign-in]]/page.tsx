    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 animate-gradient-subtle p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to your Operating Equity account</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <a href="/sign-up" className="text-blue-600 hover:text-blue-700 font-medium transition-colors duration-200">
            Sign up
          </a>
        </p>
      </div>
